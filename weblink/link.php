...
<head>
    ...
    <link rel="shortcut icon" href="foto/<?= $detail['logo'] ?>" type="image/webp">
    <link rel="icon" href="foto/logo.jpg" type="image/webp">
    <meta name="description" content="<?= $detail['judul'] ?>" />
    <meta property="og:title" content="<?= $detail['judul'] ?>" />
    <meta property="og:description" content="<?= $detail['judul'] ?>" />
    <meta property="og:image:secure_url" content="foto/logo.jpg" />
    <meta property="og:image" content="foto/logo.jpg" />
    <title><?= $detail['judul'] ?></title>
    <link rel="apple-touch-icon" sizes="180x180" href="foto/logo.jpg">
...
<body>
    <div class="min-h-full flex-h-center" id="background_div">
        ...
        <img class="page-image" data-src="foto/<?= $detail['foto'] ?>"
            alt="background" />
        ...
        <div class="mt-48 page-full-wrap relative ">
            ...
            <a href="#">
                <img class="display-image m-auto" data-src="foto/<?= $detail['logo'] ?>" src="foto/<?= $detail['logo'] ?>" alt="" />
            </a>
            <h2 class="page-title page-text-color page-text-font mt-16 text-center" style="color: white !important;">
                <?= $detail['judul'] ?>
            </h2>
            ...
            <div class="mt-24">
                ...
                ?>
                    <div class="page-item-wrap relative">
                        ...
                        <a target="_blank" class="page-item-each py-10 flex-both-center" href="<?= $data['link'] ?>" data-id="261686" data-type="page_item">
                            <span class=" item-title text-center" style="padding-left: 15px"><b><?= $data['juduldetail'] ?></b></span>
                        </a>
                    </div>
                <?php } ?>
            </div>
        ...
        var e, t = {
                ...
                80: (e, t, r) => {
                    ...
                    function i(e) {
                        var t = e.target.closest(".page-item-wrap"),
                            ...
                            a = 0;
                        r.getAttribute("data-type") && (a = 20), t.classList.toggle("show-embed"), n.src = n.getAttribute("data-src"), n.style.cssText = "height: ".concat(0 == n.offsetHeight ? o - a : 0, "px"), r.style.cssText = "height: ".concat(0 == r.offsetHeight ? o + 16 : "0", "px")
                    }
                    ...
                    function c(e) {
                        if (s(e) && (t = e, r = location.hostname.split(".").reverse(), n = r[1] + "." + r[0], document.cookie = t + "=; domain=" + n + "; Path=/; Expires=Thu, 01 Jan 1970 00:00:01 GMT;", !s(e))) {
                            try {
                                location.reload(!0)
                            } catch (e) {}
                            location.reload()
                    ...
                    function m() {
                        ...
                        if ("" != t) {
                            document.getElementById("btn-text").classList.toggle("op-0"), document.getElementById("btn-loader").classList.toggle("op-0"), document.getElementById("subsc-email-error").innerText = "", document.getElementById("subscribers-email-wrap").classList.remove("error-wrap");
                            var o = new FormData;
                            o.append("email", t);
                            ...
                            i.withCredentials = !0, i.onreadystatechange = function() {
                                if (4 === i.readyState && 200 === i.status) {
                                    ...
                                    f = !0, document.getElementsByClassName("show-after-success")[0].classList.remove("hidden"), setTimeout((function() {
                                        document.getElementsByClassName("thank-you-title")[0].classList.toggle("hidden"), document.getElementById("featured-subscribers").style.cursor = "pointer", document.getElementById("featured-subscribers").classList.toggle("hide-subscribers")
                                    }), 3e3)
                                } else "" != i.responseText && JSON.parse(i.responseText).errors && p(JSON.parse(i.responseText).errors.email[0]), f = !1
                            }, i.open("post", "".concat(u, "/api/pages/").concat(r, "/campaign/").concat(n, "/subscriber")), i.setRequestHeader("X-XSRF-TOKEN", a), i.send(o)
                    ...
                    function p(e) {
                        document.getElementById("subscribers-email-wrap").classList.add("error-wrap"), document.getElementById("subsc-email-error").innerText = e, document.getElementById("btn-text").classList.remove("op-0"), document.getElementById("btn-loader").classList.add("op-0")
                    }
                    ...
                    window.onload = function() {
                        ...
                        function() {
                            for (var e = document.getElementsByTagName("a"), t = 0; t < e.length; t++) e[t].addEventListener("click", (function(e) {
                        ...
                        null == h && "true" == l && ("creator-page" == t && (document.getElementById("toggle-subscription-btn").addEventListener("click", (function(e) {
                            document.getElementById("featured-subscribers").classList.toggle("hide-subscribers"), f && document.getElementsByClassName("thank-you-title")[0].classList.toggle("hidden"), document.getElementById("featured-subscribers").style.cursor = "default"
                ...
                666: e => {
                    var t = function(e) {
                        ...
                        return y.prototype = L.constructor = v, v.constructor = y, y.displayName = c(v, s, "GeneratorFunction"), e.isGeneratorFunction = function(e) {
